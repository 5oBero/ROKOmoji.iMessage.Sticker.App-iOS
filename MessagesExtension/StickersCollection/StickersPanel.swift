...
class StickersPanel: UIView {
    static let stickerIconSize: CGFloat = 30.0
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        flowLayout.minimumInteritemSpacing = StickersPanel.stickerSpacing
        flowLayout.minimumLineSpacing = StickersPanel.stickerSpacing
