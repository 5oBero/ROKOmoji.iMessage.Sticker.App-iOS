...
extension FileManager {
	...
	class func imageURL(forSticker sticker: ROKOSticker, inPack pack: ROKOStickerPack) -> URL {
		...
		let imageURL = folderURL.appendingPathComponent("image_\(sticker.imageInfo.objectId.stringValue)\(baseExt)")
		return imageURL
	}
	
//	class func iconURL(forSticker sticker: ROKOSticker, inPack pack: ROKOStickerPack) -> URL {
//		let folderURL = self.folderURLForPack(pack: pack)
//		let iconURL = folderURL.appendingPathComponent("icon_\(sticker.imageInfo.objectId.stringValue)\(baseExt)")
//		return iconURL
//	}
	...
	class func packIconURL(forPack pack: ROKOStickerPack) -> URL {
        ...
        let iconURL = folderURL.appendingPathComponent("packIcon_\(hash)\(baseExt)")
		return iconURL
	}
	...
	class func selectedPackIconURL(forPack pack: ROKOStickerPack) -> URL {
        ...
        let iconURL = folderURL.appendingPathComponent("selectedPackIcon_\(hash)\(baseExt)")
		return iconURL
	}
